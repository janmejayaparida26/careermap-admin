...
const navSections = [
  ...
  { label: "CAREER",     items: [{ icon: DollarSign, name: "Salary Range", path:"/salary" }, { icon: Briefcase, name: "Job Scope" }, { icon: GitBranch, name: "Path Type" }, { icon: MapPin, name: "Career Path" }, { icon: ClipboardList, name: "Entrance Exam" }, { icon: Building2, name: "Institution" }, { icon: Video, name: "Master Class" }, { icon: Award, name: "Scholarship" }] },
