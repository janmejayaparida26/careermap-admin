...
const navSections = [
  ...
  { label: "REPORT", items: [{ icon: IndianRupeeIcon, name: "Transactions", path:"/transactions"}, { icon: LogInIcon, name: "Login Activities", path:"/loginactivities"}, { icon: notification, name: "Notifications", path:"/notifications"}]}
];
