...
const navSections = [
  ...
  { label: "CONTENT",    items: [{ icon: BookOpen, name: "Modules", path:"/module" }, { icon: Layers, name: "Stream", path:"/stream" }, { icon: Tag, name: "Categories", path:"/categories" }, { icon: Tags, name: "2nd Categories" }, { icon: Tags, name: "Subcategories" }] },
